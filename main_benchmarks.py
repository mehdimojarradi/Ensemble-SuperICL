...
if __name__ == "__main__":
    ...
    if args.run_icl:
        ...
        print(f'Saving results in data/{args.context_source}_{args.test_source}/icl/{args.dataset}/{file_name}.json')
        with open(f'data/{args.context_source}_{args.test_source}/icl/{args.dataset}/{file_name}.json', 'w') as f:
            json.dump(data, f)
    ...
    if args.run_esupericl:
        ...
        if dataset_name not in args.plugins[0]:
            finetune_type = extract_finetune_type(args.plugins)
            context_json = f"data/plugin_data/adj_finetune/{args.dataset}/{args.dataset}_context_{args.context_source}_{args.seed}_ftype_{finetune_type}.json"
        else:
        ...
        if dataset_name not in args.plugins[0]:
            finetune_type = extract_finetune_type(args.plugins)
            test_json = f"data/plugin_data/adj_finetune/{args.dataset}/{args.dataset}_{args.test_source}_examples_ftype_{finetune_type}.json"
        else:
        ...
        if dataset_name not in args.plugins[0]:
            ...
            print(f'Saving results in data/{args.context_source}_{args.test_source}/adj_finetune/{args.dataset}/{finetune_type}_finetune/{directory}/{file_name}.json')
            with open(f'data/{args.context_source}_{args.test_source}/adj_finetune/{args.dataset}/{finetune_type}_finetune/{directory}/{file_name}.json', 'w') as f:
                json.dump(data, f)
        else:    
            # print(f'Saving results in data/{args.context_source}_{args.test_source}/{directory}/{args.dataset}/{file_name}.json')
            print(f'Saving results in data/zero_shot/{args.dataset}/{directory}/{file_name}.json')
            with open(f'data/zero_shot/{args.dataset}/{directory}/{file_name}.json', 'w') as f:
                json.dump(data, f)